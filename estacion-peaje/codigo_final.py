...
def llegada_vehiculos(entorno, estacion: str, cabinas: simpy.Resource):
    ...
    while True:     # Bucle infinito para simular la llegada continua de vehículos
        ...
        # {'grande': 60, 'mediano': 70, 'pequeño': 40, 'motocicleta': 380}  # Tiempo entre llegadas fuera de horas pico (en segundos)
...
def control_cabinas(entorno, estacion: str, cabinas: simpy.Resource):
    while True:
        ...
        if cabinas.capacity != nueva_capacidad:
            ...
            # cabinas.capacity = nueva_capacidad  # NO ANDA
            cabinas = simpy.Resource(entorno, capacity=nueva_capacidad) # NO ANDA

        yield entorno.timeout(60)  # Revisa o ejecuta cada hora el control
...
# Cálculo del costo de habilitar una cabina extra y la multa necesaria
